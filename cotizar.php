...
<div class="col_7">
    <h5>Cotizar</h5>
    <p>Si requiere apoyo con un diseño no dude en solicitarnos ayuda.</p>
                                                        <form name="frm" id="frm" action="cotizar.php" method="post" enctype="multipart/form-data">
            <dl>
                ...
                <dt><label>Archivos Adjuntos:<span>Archivos válidos: PDF, DXF y DWG</span></label>&nbsp;&nbsp;&nbsp;<a href="cotizar.php#a" onclick="addField()" accesskey="5">A&ntilde;adir Archivo</a></dt>
...
<img src="email.jpg"/>
<a id="link-top" href="cotizar.php#top-of-page">Top</a>
