<html>
    ...
    <body><a id="top-of-page"></a> <div id="wrap" class="clearfix">
            ...
            <ul class="menu center">
                ...
                    <li class="current"><a href="http://complejoindustrial.com/bolsa.html">Bolsa de Trabajo</a></li>
            </ul>
            <!-- END Menu Horizontal -->
            ...
            <div class="col_12">
                ...
                <div class="col_8 left">
                    ...
                    <div class="col_7">
                        <h5 class="center">Bolsa de Trabajo</h5>
                        <p>¡Unete a nuestro equipo de trabajo! Manda tu CV.</p>
                        <br>
                                                <form name="frm" id="frm" action="bolsa.php" method="post" enctype="multipart/form-data">
                            <dl>
                                ...
                                <dt><label>Archivos Adjuntos:<span>Archivos válidos: PDF y DOC</span></label>&nbsp;&nbsp;&nbsp;<a href="bolsa.php#a" onclick="addField()" accesskey="5">A&ntilde;adir Archivo</a></dt>
                ...
                <div id="footer">
                    ...
                    <img src="email.jpg"/>
                    <a id="link-top" href="bolsa.php#top-of-page">Top</a>
